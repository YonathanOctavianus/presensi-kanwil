    ...
    <div class="py-10 bg-platinum min-h-screen font-titillium">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
           ...
           {{-- 3. STATISTIK PRESENSI TERPISAH --}}
            <div class="mb-8">
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                        ...
                        {{-- Tepat Waktu (Magang) --}}
                        <a href="{{ route('dashboard', array_merge(['filter' => 'tepat_waktu_magang'], request()->only('tanggal'))) }}" 
                        class="bg-white p-5 rounded-xl shadow-lg border border-slate-100 hover:shadow-xl hover:border-emerald-500 hover:-translate-y-0.5 transition duration-300 relative overflow-hidden group cursor-pointer {{ request('filter') == 'tepat_waktu_magang' ? 'ring-2 ring-emerald-500 bg-emerald-50' : '' }}">
                            <div class="relative z-10">
                                <div class="flex items-center justify-between mb-3">
                                ...
                                <h3 class="text-3xl font-extrabold text-emerald-600 tracking-tight mb-1">{{ $tepatWaktuMagang ?? 0 }}</h3>
                                <p class="text-xs text-slate-500 font-medium">Tepat Waktu</p>
                            </div>
                        ...
                        {{-- Terlambat (Magang) --}}
                        <a href="{{ route('dashboard', array_merge(['filter' => 'terlambat_magang'], request()->only('tanggal'))) }}" 
                        class="bg-white p-5 rounded-xl shadow-lg border border-slate-100 hover:shadow-xl hover:border-amber-500 hover:-translate-y-0.5 transition duration-300 relative overflow-hidden group cursor-pointer {{ request('filter') == 'terlambat_magang' ? 'ring-2 ring-amber-500 bg-amber-50' : '' }}">
                            <div class="relative z-10">
                                <div class="flex items-center justify-between mb-3">
                                    <div class="p-2 bg-amber-50 text-amber-500 rounded-lg group-hover:bg-amber-500 group-hover:text-white transition">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                        </svg>
                                    </div>
                                ...
                                <h3 class="text-3xl font-extrabold text-amber-500 tracking-tight mb-1">{{ $terlambatMagang ?? 0 }}</h3>
                                <p class="text-xs text-slate-500 font-medium">Terlambat</p>
                            </div>
                        ...
                        class="bg-white p-5 rounded-xl shadow-lg border border-slate-100 hover:shadow-xl hover:border-red-500 hover:-translate-y-0.5 transition duration-300 relative overflow-hidden group cursor-pointer {{ request('filter') == 'belum_hadir_magang' ? 'ring-2 ring-red-500 bg-red-50' : '' }}">
                            <div class="relative z-10">
                                <div class="flex items-center justify-between mb-3">
                                    <div class="p-2 bg-red-50 text-red-500 rounded-lg group-hover:bg-red-500 group-hover:text-white transition">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                                        </svg>
                                    </div>
                                ...
                                <h3 class="text-3xl font-extrabold text-slate-700 tracking-tight mb-1">{{ $belumHadirMagang ?? 0 }}</h3>
                                <p class="text-xs text-slate-500 font-medium">Belum Hadir</p>
                            </div>
                ...
                <div>
                    <div class="flex items-center gap-2 mb-4">
                        ...
                        <h4 class="font-bold text-midnight text-sm uppercase tracking-wider">PEGAWAI</h4>
                        <span class="text-xs text-slate-500 ml-2">(Presensi Apel Pagi)</span>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        {{-- Total Anggota Pegawai --}}
                        ...
                        class="bg-white p-5 rounded-xl shadow-lg border border-slate-100 hover:shadow-xl hover:border-blue-500 hover:-translate-y-0.5 transition duration-300 relative overflow-hidden group cursor-pointer {{ request('filter') == 'total_pegawai' ? 'ring-2 ring-blue-500 bg-blue-50' : '' }}">
                            <div class="relative z-10">
                                ...
                                <p class="text-xs text-slate-500 font-medium">Total Anggota Pegawai</p>
                            </div>
                        ...
                        class="bg-white p-5 rounded-xl shadow-lg border border-slate-100 hover:shadow-xl hover:border-green-500 hover:-translate-y-0.5 transition duration-300 relative overflow-hidden group cursor-pointer {{ request('filter') == 'kehadiran_apel_pegawai' ? 'ring-2 ring-green-500 bg-green-50' : '' }}">
                            <div class="relative z-10">
                                ...
                                <h3 class="text-3xl font-extrabold text-green-600 tracking-tight mb-1">{{ $hadirApelPegawai ?? 0 }}</h3>
                                <p class="text-xs text-slate-500 font-medium">Kehadiran Apel</p>
                            </div>
                        ...
                        class="bg-white p-5 rounded-xl shadow-lg border border-slate-100 hover:shadow-xl hover:border-red-500 hover:-translate-y-0.5 transition duration-300 relative overflow-hidden group cursor-pointer {{ request('filter') == 'tidak_hadir_apel_pegawai' ? 'ring-2 ring-red-500 bg-red-50' : '' }}">
                            <div class="relative z-10">
                                ...
                                <h3 class="text-3xl font-extrabold text-red-500 tracking-tight mb-1">{{ $tidakHadirApelPegawai ?? 0 }}</h3>
            ...
            {{-- MODE FILTER: TOTAL MAGANG --}}
            @if(request('filter') == 'total_magang')
                <div class="bg-white rounded-xl shadow-lg border border-purple-200 overflow-hidden mb-10 animate-fade-in-up">
                    <div class="bg-purple-700 px-6 py-4 border-b-4 border-purple-500 flex justify-between items-center relative overflow-hidden">
                        ...
                        <div class="relative z-10 flex items-center gap-3">
                            ...
                            <div>
                                <h3 class="text-lg font-bold text-white tracking-wide">Daftar Semua Peserta Magang</h3>
                                <p class="text-xs text-white/80">Total: {{ $totalMagang ?? 0 }} peserta | Tanggal: {{ $tanggalDisplay }}</p>
                            </div>
                        </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full text-left">
                            <thead class="bg-purple-50 text-purple-800 uppercase text-xs tracking-wider border-b border-purple-100">
                                <tr>
                            ...
                            <tbody class="divide-y divide-purple-50 text-sm">
                                @forelse ($totalMagangList as $p)
                                    @php
                                        $hadirHariIni = false;
                                        $statusKehadiran = 'Belum Hadir';
                                        if (isset($riwayatMagang)) {
                                            foreach ($riwayatMagang as $rm) {
                                                if (($rm['pegawai']->id ?? null) == $p->id) {
                                                    $hadirHariIni = true;
                                                    $statusKehadiran = $rm['status'] ?? 'Hadir';
                                                    break;
                                                }
                                            }
                                        }
                                    ...
                                    <tr class="hover:bg-purple-50 transition">
                                        ...
                                        <td class="py-4 px-6 font-bold text-purple-700">{{ $p->nama }}</td>
                                        <td class="py-4 px-6 text-slate-500">{{ $p->jabatan }}</td>
                                        <td class="py-4 px-6">
                                            @if($hadirHariIni)
                                                @if($statusKehadiran == 'tepat_waktu')
                                                ...
                                                @else
                                                    <span class="text-xs font-bold text-blue-600 bg-blue-50 px-3 py-1 rounded-full border border-blue-100">Sudah Hadir</span>
                                                @endif
                                            @else
                                    ...
                                    <tr>
                                        <td colspan="4" class="py-8 text-center text-slate-400">
                                            <div class="flex flex-col items-center gap-2">
                                                ...
                                                <span>Tidak ada data peserta magang.</span>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
                                ...
                                @forelse ($tepatWaktuMagangList as $p)
                                    <tr class="hover:bg-emerald-50 transition">
                                        <td class="py-4 px-6 font-mono font-bold text-slate-700">
                                            {{ \Carbon\Carbon::parse($p->jam_masuk)->setTimezone('Asia/Jakarta')->format('H:i') }} WIB
                                        </td>
                                        <td class="py-4 px-6">
                            ...
                            <tbody class="divide-y divide-red-50 text-sm">
                                @forelse ($belumHadirMagangList as $p)
                                    <tr class="hover:bg-red-50 transition">
                                        <td class="py-4 px-6 font-mono text-slate-600">{{ $p->nip }}</td>
                                        <td class="py-4 px-6 font-bold text-red-700">{{ $p->nama }}</td>
                                        <td class="py-4 px-6 text-slate-500">{{ $p->jabatan }}</td>
                                        <td class="py-4 px-6">
                                            <span class="text-xs font-bold text-red-600 bg-red-50 px-3 py-1 rounded-full border border-red-100">Belum Hadir</span>
                                        </td>
                            ...
                            <tbody class="divide-y divide-blue-50 text-sm">
                                @forelse ($totalPegawaiList as $p)
                                    ...
                                    <tr class="hover:bg-blue-50 transition">
                                        <td class="py-4 px-6 font-mono text-slate-600">{{ $p->nip }}</td>
                                        <td class="py-4 px-6 font-bold text-blue-700">{{ $p->nama }}</td>
                                        <td class="py-4 px-6 text-slate-500">{{ $p->jabatan }}</td>
                                        <td class="py-4 px-6">
                                            @if($hadirApel)
            ...
            {{-- MODE 3: TEPAT WAKTU / TERLAMBAT (LAMA) --}}
